...
```{r}
pHcalib<-read_csv(here("Test Sampling", "tris_calibration.csv"))
pHData<-read_csv(here("Test Sampling", "Tidepool Data", "tidepool_chemistry.csv"))
```
...
Write the data
```{r}
write_csv(pHSlope, here("Test Sampling", "pHSlope.csv"))
```
