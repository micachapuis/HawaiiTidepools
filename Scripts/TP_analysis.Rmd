...
kb_wind <- read_csv(here("Data", "Climate", "KB_0551_20250101_20260305.csv"))
sb_wind <- read_csv(here("Data", "Climate", "SB_0531_20250101_20260223.csv"))
```
...
```{r}
deltas %>% filter(!site %in% "Diamond Head") %>% ggplot(aes(x = delta_temp, y = delta_pH, color = site)) + geom_point()
```
